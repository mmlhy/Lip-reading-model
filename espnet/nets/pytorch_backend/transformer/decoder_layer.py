...
from espnet.s4.s4.s4d import S4D

class DecoderLayer_s4(nn.Module):
    ...
    def __init__(
        ...
        super(DecoderLayer_s4, self).__init__()
        self.size = size
...
class DecoderLayer_trans(nn.Module):
    """Single decoder layer module.
    :param int size: input dim
    :param espnet.nets.pytorch_backend.transformer.attention.MultiHeadedAttention
        self_attn: self attention module
    ...
    def __init__(
        ...
        """Construct an DecoderLayer object."""
        super(DecoderLayer_trans, self).__init__()
        self.size = size
